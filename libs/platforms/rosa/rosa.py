...
class Rosa(Platform):
    ...
    def _get_workers_ready(self, kubeconfig, cluster_name):
        myenv = os.environ.copy()
        myenv["KUBECONFIG"] = kubeconfig
        self.logging.info(f"Getting node information for cluster {cluster_name}")
    ...
    def get_cluster_admin_access(self, cluster_name, path):
        ...
        while (datetime.datetime.utcnow().timestamp() < cluster_admin_create_time + 30 * 60):
            ...
            if process.returncode != 0:
                ...
                return_data["cluster-admin-create"] = (int(datetime.datetime.utcnow().timestamp()) - cluster_admin_create_time)
                ...
                while datetime.datetime.utcnow().timestamp() < oc_login_time + 30 * 60:
                    ...
                    if oc_login_code != 0:
                        ...
                        return_data["cluster-admin-login"] = (int(datetime.datetime.utcnow().timestamp()) - oc_login_time)
